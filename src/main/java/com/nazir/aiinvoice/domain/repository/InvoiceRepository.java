...
public interface InvoiceRepository extends JpaRepository<Invoice, UUID>, JpaSpecificationExecutor<Invoice> {
    boolean existsByVendorNameAndInvoiceNumberAndTotalAmountAndIdNot(String vendorName, String invoiceNumber, BigDecimal totalAmount, UUID id);

    boolean existsByVendorNameAndInvoiceNumberAndIdNot(String vendorName, String invoiceNumber, UUID id);
